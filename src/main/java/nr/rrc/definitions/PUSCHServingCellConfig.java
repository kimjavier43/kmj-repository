...
public class PUSCHServingCellConfig implements BerType, Serializable {
	...
	private BerEnum rateMatching = null;
	private BerEnum xOverhead = null;
	
	public PUSCHServingCellConfig() {
	}

	public PUSCHServingCellConfig(byte[] code) {
		this.code = code;
	}
	...
	public void setRateMatching(BerEnum rateMatching) {
		this.rateMatching = rateMatching;
	}

	public BerEnum getRateMatching() {
		return rateMatching;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (rateMatching != null) {
			codeLength += rateMatching.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
			rateMatching = new BerEnum();
			subCodeLength += rateMatching.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
			subCodeLength += berTag.decode(is);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (rateMatching != null) {
			...
			sb.append("rateMatching: ").append(rateMatching);
			firstSelectedElement = false;
		}
