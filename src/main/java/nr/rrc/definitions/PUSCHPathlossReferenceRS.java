...
public class PUSCHPathlossReferenceRS implements BerType, Serializable {
	...
	public byte[] code = null;
	private PUSCHPathlossReferenceRSId puschPathlossReferenceRSId = null;
	private ReferenceSignal referenceSignal = null;
	
	public PUSCHPathlossReferenceRS() {
	}

	public PUSCHPathlossReferenceRS(byte[] code) {
		this.code = code;
	}

	public void setPuschPathlossReferenceRSId(PUSCHPathlossReferenceRSId puschPathlossReferenceRSId) {
		this.puschPathlossReferenceRSId = puschPathlossReferenceRSId;
	}

	public PUSCHPathlossReferenceRSId getPuschPathlossReferenceRSId() {
		return puschPathlossReferenceRSId;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += puschPathlossReferenceRSId.encode(reverseOS, false);
		// write tag: CONTEXT_CLASS, PRIMITIVE, 0
		reverseOS.write(0x80);
		codeLength += 1;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			puschPathlossReferenceRSId = new PUSCHPathlossReferenceRSId();
			subCodeLength += puschPathlossReferenceRSId.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (puschPathlossReferenceRSId != null) {
			sb.append("puschPathlossReferenceRSId: ").append(puschPathlossReferenceRSId);
		}
		else {
			sb.append("puschPathlossReferenceRSId: <empty-required-field>");
		}
