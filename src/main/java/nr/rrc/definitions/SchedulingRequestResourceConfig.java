...
public class SchedulingRequestResourceConfig implements BerType, Serializable {
	...
	public static class PeriodicityAndOffset implements BerType, Serializable {
		...
		private BerNull sym2 = null;
		private BerNull sym6or7 = null;
		...
		public void setSym2(BerNull sym2) {
			this.sym2 = sym2;
		}

		public BerNull getSym2() {
			return sym2;
		}

		public void setSym6or7(BerNull sym6or7) {
			this.sym6or7 = sym6or7;
		}

		public BerNull getSym6or7() {
			return sym6or7;
		}
		...
		public int encode(OutputStream reverseOS) throws IOException {
			...
			if (sym6or7 != null) {
				codeLength += sym6or7.encode(reverseOS, false);
			...
			if (sym2 != null) {
				codeLength += sym2.encode(reverseOS, false);
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
				sym2 = new BerNull();
				codeLength += sym2.decode(is, false);
				return codeLength;
			}

			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
				sym6or7 = new BerNull();
				codeLength += sym6or7.decode(is, false);
				return codeLength;
			}
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (sym2 != null) {
				sb.append("sym2: ").append(sym2);
				return;
			}

			if (sym6or7 != null) {
				sb.append("sym6or7: ").append(sym6or7);
				return;
			}
	...
	public byte[] code = null;
	private SchedulingRequestResourceId schedulingRequestResourceId = null;
	private SchedulingRequestId schedulingRequestID = null;
	private PeriodicityAndOffset periodicityAndOffset = null;
	private PUCCHResourceId resource = null;
	
	public SchedulingRequestResourceConfig() {
	}

	public SchedulingRequestResourceConfig(byte[] code) {
		this.code = code;
	}

	public void setSchedulingRequestResourceId(SchedulingRequestResourceId schedulingRequestResourceId) {
		this.schedulingRequestResourceId = schedulingRequestResourceId;
	}

	public SchedulingRequestResourceId getSchedulingRequestResourceId() {
	...
	public void setResource(PUCCHResourceId resource) {
		this.resource = resource;
	}

	public PUCCHResourceId getResource() {
		return resource;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += schedulingRequestResourceId.encode(reverseOS, false);
		// write tag: CONTEXT_CLASS, PRIMITIVE, 0
		reverseOS.write(0x80);
		codeLength += 1;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			...
			subCodeLength += schedulingRequestResourceId.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (schedulingRequestResourceId != null) {
			sb.append("schedulingRequestResourceId: ").append(schedulingRequestResourceId);
		}
		else {
			sb.append("schedulingRequestResourceId: <empty-required-field>");
		}
