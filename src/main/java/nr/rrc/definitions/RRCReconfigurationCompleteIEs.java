...
public class RRCReconfigurationCompleteIEs implements BerType, Serializable {
	...
	public RRCReconfigurationCompleteIEs() {
	}

	public RRCReconfigurationCompleteIEs(byte[] code) {
		this.code = code;
	}
