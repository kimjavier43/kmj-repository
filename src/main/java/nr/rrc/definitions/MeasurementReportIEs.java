...
public class MeasurementReportIEs implements BerType, Serializable {
	...
	public byte[] code = null;
	private MeasResults measResults = null;
	private BerOctetString lateNonCriticalExtension = null;
	private NonCriticalExtension nonCriticalExtension = null;
	
	public MeasurementReportIEs() {
	}

	public MeasurementReportIEs(byte[] code) {
		this.code = code;
	}

	public void setMeasResults(MeasResults measResults) {
		this.measResults = measResults;
	}

	public MeasResults getMeasResults() {
		return measResults;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += measResults.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
			...
			subCodeLength += measResults.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (measResults != null) {
			sb.append("measResults: ");
			measResults.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("measResults: <empty-required-field>");
		}
