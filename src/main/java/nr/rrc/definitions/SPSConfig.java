...
public class SPSConfig implements BerType, Serializable {
	...
	private PUCCHResourceId n1PUCCHAN = null;
	
	public SPSConfig() {
	}

	public SPSConfig(byte[] code) {
		this.code = code;
	}
	...
	public void setN1PUCCHAN(PUCCHResourceId n1PUCCHAN) {
		this.n1PUCCHAN = n1PUCCHAN;
	}

	public PUCCHResourceId getN1PUCCHAN() {
		return n1PUCCHAN;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		if (n1PUCCHAN != null) {
			codeLength += n1PUCCHAN.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 2)) {
			n1PUCCHAN = new PUCCHResourceId();
			subCodeLength += n1PUCCHAN.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (n1PUCCHAN != null) {
			...
			sb.append("n1PUCCHAN: ").append(n1PUCCHAN);
		}
