...
public class CSIReportPeriodicityAndOffset implements BerType, Serializable {
	...
	public CSIReportPeriodicityAndOffset() {
	}

	public CSIReportPeriodicityAndOffset(byte[] code) {
		this.code = code;
	}
