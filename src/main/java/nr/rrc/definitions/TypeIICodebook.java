...
public class TypeIICodebook implements BerType, Serializable {
	...
	private BerEnum amplitudeSubsetRestriction = null;
	private BerInteger maxNumberCSIRSPerResourceSet = null;
	
	public TypeIICodebook() {
	}

	public TypeIICodebook(byte[] code) {
		this.code = code;
	}
	...
	public void setAmplitudeSubsetRestriction(BerEnum amplitudeSubsetRestriction) {
		this.amplitudeSubsetRestriction = amplitudeSubsetRestriction;
	}

	public BerEnum getAmplitudeSubsetRestriction() {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (amplitudeSubsetRestriction != null) {
			codeLength += amplitudeSubsetRestriction.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 5)) {
			amplitudeSubsetRestriction = new BerEnum();
			subCodeLength += amplitudeSubsetRestriction.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (amplitudeSubsetRestriction != null) {
			...
			sb.append("amplitudeSubsetRestriction: ").append(amplitudeSubsetRestriction);
		}
