...
public class ZPCSIRSResource implements BerType, Serializable {
	...
	private ZPCSIRSResourceId zpCSIRSResourceId = null;
	private CSIRSResourceMapping resourceMapping = null;
	private CSIResourcePeriodicityAndOffset periodicityAndOffset = null;
	
	public ZPCSIRSResource() {
	}

	public ZPCSIRSResource(byte[] code) {
		this.code = code;
	}

	public void setZpCSIRSResourceId(ZPCSIRSResourceId zpCSIRSResourceId) {
		this.zpCSIRSResourceId = zpCSIRSResourceId;
	}

	public ZPCSIRSResourceId getZpCSIRSResourceId() {
		return zpCSIRSResourceId;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += zpCSIRSResourceId.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			zpCSIRSResourceId = new ZPCSIRSResourceId();
			subCodeLength += zpCSIRSResourceId.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (zpCSIRSResourceId != null) {
			sb.append("zpCSIRSResourceId: ").append(zpCSIRSResourceId);
		}
		else {
			sb.append("zpCSIRSResourceId: <empty-required-field>");
		}
