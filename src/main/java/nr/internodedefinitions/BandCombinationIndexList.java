...
public class BandCombinationIndexList implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 16);
	public byte[] code = null;
	private List<BandCombinationIndex> seqOf = null;

	public BandCombinationIndexList() {
		seqOf = new ArrayList<BandCombinationIndex>();
	}

	public BandCombinationIndexList(byte[] code) {
		this.code = code;
	}

	public List<BandCombinationIndex> getBandCombinationIndex() {
		if (seqOf == null) {
			seqOf = new ArrayList<BandCombinationIndex>();
		}
		return seqOf;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		while (subCodeLength < totalLength) {
			BandCombinationIndex element = new BandCombinationIndex();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<BandCombinationIndex> it = seqOf.iterator();
			if (it.hasNext()) {
				sb.append(it.next());
				while (it.hasNext()) {
					sb.append(",\n");
