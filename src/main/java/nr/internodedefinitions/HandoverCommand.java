...
public class HandoverCommand implements BerType, Serializable {
	...
	public static class CriticalExtensions implements BerType, Serializable {
		...
		public static class C1 implements BerType, Serializable {
			...
			public byte[] code = null;
			private HandoverCommandIEs handoverCommand = null;
			...
			public void setHandoverCommand(HandoverCommandIEs handoverCommand) {
				this.handoverCommand = handoverCommand;
			}

			public HandoverCommandIEs getHandoverCommand() {
			...
			public int encode(OutputStream reverseOS) throws IOException {
				...
				if (handoverCommand != null) {
					codeLength += handoverCommand.encode(reverseOS, false);
			...
			public int decode(InputStream is, BerTag berTag) throws IOException {
				...
				if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
					handoverCommand = new HandoverCommandIEs();
					codeLength += handoverCommand.decode(is, false);
					return codeLength;
				}
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (handoverCommand != null) {
					sb.append("handoverCommand: ");
					handoverCommand.appendAsString(sb, indentLevel + 1);
					return;
				}
	...
	public HandoverCommand(byte[] code) {
		this.code = code;
	}
