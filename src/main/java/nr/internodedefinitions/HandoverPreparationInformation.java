...
public class HandoverPreparationInformation implements BerType, Serializable {
	...
	public static class CriticalExtensions implements BerType, Serializable {
		...
		public static class C1 implements BerType, Serializable {
			...
			public byte[] code = null;
			private HandoverPreparationInformationIEs handoverPreparationInformation = null;
			...
			public void setHandoverPreparationInformation(HandoverPreparationInformationIEs handoverPreparationInformation) {
				this.handoverPreparationInformation = handoverPreparationInformation;
			}

			public HandoverPreparationInformationIEs getHandoverPreparationInformation() {
			...
			public int encode(OutputStream reverseOS) throws IOException {
				...
				if (handoverPreparationInformation != null) {
					codeLength += handoverPreparationInformation.encode(reverseOS, false);
			...
			public int decode(InputStream is, BerTag berTag) throws IOException {
				...
				if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
					handoverPreparationInformation = new HandoverPreparationInformationIEs();
					codeLength += handoverPreparationInformation.decode(is, false);
					return codeLength;
				}
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (handoverPreparationInformation != null) {
					sb.append("handoverPreparationInformation: ");
					handoverPreparationInformation.appendAsString(sb, indentLevel + 1);
					return;
				}
	...
	public HandoverPreparationInformation(byte[] code) {
		this.code = code;
	}
