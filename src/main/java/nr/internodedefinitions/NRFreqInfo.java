...
public class NRFreqInfo implements BerType, Serializable {
	...
	private ARFCNValueNR measuredFrequency = null;
	
	public NRFreqInfo() {
	}

	public NRFreqInfo(byte[] code) {
		this.code = code;
	}

	public void setMeasuredFrequency(ARFCNValueNR measuredFrequency) {
		this.measuredFrequency = measuredFrequency;
	}

	public ARFCNValueNR getMeasuredFrequency() {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (measuredFrequency != null) {
			codeLength += measuredFrequency.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			measuredFrequency = new ARFCNValueNR();
			subCodeLength += measuredFrequency.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (measuredFrequency != null) {
			...
			sb.append("measuredFrequency: ").append(measuredFrequency);
		}
