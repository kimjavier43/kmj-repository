...
public class MeasConfigSN implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static class MeasuredFrequenciesSN implements BerType, Serializable {
		...
		public MeasuredFrequenciesSN() {
			seqOf = new ArrayList<NRFreqInfo>();
		}

		public MeasuredFrequenciesSN(byte[] code) {
			this.code = code;
		}
	...
	public byte[] code = null;
	private MeasuredFrequenciesSN measuredFrequenciesSN = null;
	
	public MeasConfigSN() {
	}

	public MeasConfigSN(byte[] code) {
		this.code = code;
	}

	public void setMeasuredFrequenciesSN(MeasuredFrequenciesSN measuredFrequenciesSN) {
		this.measuredFrequenciesSN = measuredFrequenciesSN;
	}

	public MeasuredFrequenciesSN getMeasuredFrequenciesSN() {
		return measuredFrequenciesSN;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (measuredFrequenciesSN != null) {
			codeLength += measuredFrequenciesSN.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
			measuredFrequenciesSN = new MeasuredFrequenciesSN();
			subCodeLength += measuredFrequenciesSN.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (measuredFrequenciesSN != null) {
			...
			sb.append("measuredFrequenciesSN: ");
			measuredFrequenciesSN.appendAsString(sb, indentLevel + 1);
		}
