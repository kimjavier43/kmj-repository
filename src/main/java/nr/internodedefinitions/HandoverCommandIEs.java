...
public class HandoverCommandIEs implements BerType, Serializable {
	...
	public byte[] code = null;
	private BerOctetString handoverCommandMessage = null;
	private NonCriticalExtension nonCriticalExtension = null;
	
	public HandoverCommandIEs() {
	}

	public HandoverCommandIEs(byte[] code) {
		this.code = code;
	}

	public void setHandoverCommandMessage(BerOctetString handoverCommandMessage) {
		this.handoverCommandMessage = handoverCommandMessage;
	}

	public BerOctetString getHandoverCommandMessage() {
		return handoverCommandMessage;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += handoverCommandMessage.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			handoverCommandMessage = new BerOctetString();
			subCodeLength += handoverCommandMessage.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (handoverCommandMessage != null) {
			sb.append("handoverCommandMessage: ").append(handoverCommandMessage);
		}
		else {
			sb.append("handoverCommandMessage: <empty-required-field>");
		}
