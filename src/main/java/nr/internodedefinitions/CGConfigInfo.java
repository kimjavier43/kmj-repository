...
public class CGConfigInfo implements BerType, Serializable {
	...
	public static class CriticalExtensions implements BerType, Serializable {
		...
		public static class C1 implements BerType, Serializable {
			...
			public byte[] code = null;
			private CGConfigInfoIEs cgConfigInfo = null;
			...
			public void setCgConfigInfo(CGConfigInfoIEs cgConfigInfo) {
				this.cgConfigInfo = cgConfigInfo;
			}

			public CGConfigInfoIEs getCgConfigInfo() {
				return cgConfigInfo;
			}
			...
			public int encode(OutputStream reverseOS) throws IOException {
				...
				if (cgConfigInfo != null) {
					codeLength += cgConfigInfo.encode(reverseOS, false);
			...
			public int decode(InputStream is, BerTag berTag) throws IOException {
				...
				if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
					cgConfigInfo = new CGConfigInfoIEs();
					codeLength += cgConfigInfo.decode(is, false);
					return codeLength;
				}
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (cgConfigInfo != null) {
					sb.append("cgConfigInfo: ");
					cgConfigInfo.appendAsString(sb, indentLevel + 1);
					return;
				}
