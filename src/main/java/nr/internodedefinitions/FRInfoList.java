...
public class FRInfoList implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 16);
	public byte[] code = null;
	private List<FRInfo> seqOf = null;

	public FRInfoList() {
		seqOf = new ArrayList<FRInfo>();
	}

	public FRInfoList(byte[] code) {
		this.code = code;
	}

	public List<FRInfo> getFRInfo() {
		if (seqOf == null) {
			seqOf = new ArrayList<FRInfo>();
		}
		return seqOf;
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<FRInfo> it = seqOf.iterator();
			if (it.hasNext()) {
