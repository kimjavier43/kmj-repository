...
public class ReestabNCellInfoList implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 16);
	public byte[] code = null;
	private List<ReestabNCellInfo> seqOf = null;

	public ReestabNCellInfoList() {
		seqOf = new ArrayList<ReestabNCellInfo>();
	}

	public ReestabNCellInfoList(byte[] code) {
		this.code = code;
	}

	public List<ReestabNCellInfo> getReestabNCellInfo() {
		if (seqOf == null) {
			seqOf = new ArrayList<ReestabNCellInfo>();
		}
		return seqOf;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		while (subCodeLength < totalLength) {
			ReestabNCellInfo element = new ReestabNCellInfo();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<ReestabNCellInfo> it = seqOf.iterator();
			if (it.hasNext()) {
