...
public class MeasTimingList implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 16);
	public byte[] code = null;
	private List<MeasTiming> seqOf = null;

	public MeasTimingList() {
		seqOf = new ArrayList<MeasTiming>();
	}

	public MeasTimingList(byte[] code) {
		this.code = code;
	}

	public List<MeasTiming> getMeasTiming() {
		if (seqOf == null) {
			seqOf = new ArrayList<MeasTiming>();
		}
		return seqOf;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		while (subCodeLength < totalLength) {
			MeasTiming element = new MeasTiming();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<MeasTiming> it = seqOf.iterator();
			if (it.hasNext()) {
