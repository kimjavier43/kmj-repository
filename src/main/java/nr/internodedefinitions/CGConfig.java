...
public class CGConfig implements BerType, Serializable {
	...
	public static class CriticalExtensions implements BerType, Serializable {
		...
		public static class C1 implements BerType, Serializable {
			...
			public byte[] code = null;
			private CGConfigIEs cgConfig = null;
			...
			public void setCgConfig(CGConfigIEs cgConfig) {
				this.cgConfig = cgConfig;
			}

			public CGConfigIEs getCgConfig() {
				return cgConfig;
			}
			...
			public int encode(OutputStream reverseOS) throws IOException {
				...
				if (cgConfig != null) {
					codeLength += cgConfig.encode(reverseOS, false);
			...
			public int decode(InputStream is, BerTag berTag) throws IOException {
				...
				if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
					cgConfig = new CGConfigIEs();
					codeLength += cgConfig.decode(is, false);
					return codeLength;
				}
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (cgConfig != null) {
					sb.append("cgConfig: ");
					cgConfig.appendAsString(sb, indentLevel + 1);
					return;
				}
